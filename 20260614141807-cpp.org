...
* Dynamic arrays
:PROPERTIES:
:ID:       1242bc2a-31ab-446a-827f-634b0acc47e8
:END:
** Introduction to std::vector
:PROPERTIES:
:ID:       ab5728bc-2c84-427e-8be7-6a9cc16a0c40
:END:
...
:PROPERTIES:
:ID:       3bce83e1-e5a7-4f8f-966f-95208dcdda80
:END:
...
*** move semantics
:PROPERTIES:
:ID:       3ea4a6d2-e5fa-46bd-a7d5-6519af114de1
:END:
...
*** arrays and loop
:PROPERTIES:
:ID:       764b4e33-2cc1-4dfa-884d-a5783b127126
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
...
:PROPERTIES:
:ID:       d4e383bc-cad4-459c-b27f-61961dcfe55e
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
...
The '\n' is for the cin.ignore to know where it to stop.
** Range based for Loops
:PROPERTIES:
:ID:       5163ff1a-fc7a-471b-8a8b-6c0302b83ecb
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
...
:PROPERTIES:
:ID:       d04bbae6-231f-41bf-919d-679f21adec80
:END:
...
:PROPERTIES:
:ID:       fa55b4c5-d6fb-44df-9322-ec6c3184734c
:END:
...
*** length and capacity
:PROPERTIES:
:ID:       ff769aa6-347e-4b18-bb40-058a22fa0a6b
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
...
*** shrink_to_fit
:PROPERTIES:
:ID:       116dd243-8ec6-4aa3-8a5b-05e613df75af
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
...
:PROPERTIES:
:ID:       acd90f7a-3082-4250-ba52-ccc7650fc428
:END:
...
| Pop         | remove the top element from top      | may return removed element or void |
| Top or Peek | get the top element of the stack     | do not remove item                 |
| Emptying    | Determine if stack has no elements   |                                    |
| Size        | count how many elememts in the stack |                                    |

stack behaviour with std::vector

| push_back()    | put new element on top of stack             | Add elements to end of vector                     |
| pop_back()     | Remove element from the stack               | Returns void,removes element at the end of vector |
| back()         | get the top element on the stack            | does not remove item                              |
| emplace_back() | Alternate form of push_back() more effcient | Add elememts to the vector                        |
...
:PROPERTIES:
:ID:       619c0814-e97c-4b1d-9bcf-85d9f2f8430a
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
...
** std::vector<bool>
:PROPERTIES:
:ID:       777c7d81-b2e4-446f-9dea-151450a23115
:END:
#+begin_src cpp :results output
#include <iostream>
#include <vector>
